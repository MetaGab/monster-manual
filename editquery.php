...
$sql ="UPDATE monsters SET `name`='$name', cr='$cr', size='$size', alignment='$alignment', `type`='$type', ac=$ac, hp=$hp, speed=$speed, str=$str, dex=$dex, con=$con, `int`=$int, wis=$wis, cha=$cha WHERE id=$id";
